...
@section('content')
    ...
    <section class="pt-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-sm font-semibold text-[var(--text-dim)] uppercase tracking-wider">Cartões</h2>
            <a href="{{ route('accounts.create') }}" class="text-sm text-[var(--accent)] hover:opacity-80 transition-opacity">+ Adicionar</a>
        </div>
        <div class="space-y-4">
            ...
            {{-- Benefícios entram na mesma lista: para quem olha a Home, é tudo cartão. --}}
